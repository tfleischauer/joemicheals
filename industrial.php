            		...
            		<div class="flex-wrapper">
                        ...
                        <div class="eight-of-twelve-columns-right">
                           ...
                           <h3>Video</h3>
                             ...
                             <h4>Best of the NW (SINTR)</h4>       
                               <div> <!-- iframe-div -->
                                  <div class="iframe-wrapper">
                                    <iframe class="iframe-embed" src="https://player.vimeo.com/video/165928496" allowfullscreen></iframe>
                                  </div> <!-- end iframe wrapper -->       
                                  <p class="video-caption-small">Ski Mount St. Helens</p>
                               </div> <!-- iframe-div -->
